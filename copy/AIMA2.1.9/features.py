...
def session_features_from_metrics(
    ...
    # 4) Varus/valgus из фильтрованной колонки
    if "KneeValgus_filt_deg" in df_angles.columns:
        ...
        # если по какой-то причине колонки нет — просто обнуляем
        for k in ["valgus_mean_deg","valgus_std_deg","valgus_min_deg",
                  "valgus_max_deg","valgus_rms_deg"]:
            feats[k] = 0.0
